...
The gap between a frontier model and a merely good one is mostly *operating discipline*, not raw capability: what it says first, what it claims, when it acts, when it verifies, and when it stops. These five skills encode that discipline so it can be loaded into any session, any sub-agent brief, any model tier.
